      ...
      return {
        ...
        blocks: [
...

          {
            ...
            text: "显示不支持 Scratch 的积木",
            hideFromPalette: !compatibilityMode,
          },
          {
            blockType: Scratch.BlockType.LABEL,
            text: "不支持 Scratch 的积木：",
            hideFromPalette: compatibilityMode,
          },
          {
            opcode: "setAlignment",
            blockType: Scratch.BlockType.COMMAND,
            text: "将文本对齐方式设为 [ALIGN]",
            hideFromPalette: compatibilityMode,
            arguments: {
              ALIGN: {
                type: Scratch.ArgumentType.STRING,
          ...
          "---",
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: "将动画 [ANIMATE] 的持续时间设为 [NUM] 秒",
            hideFromPalette: compatibilityMode,
            arguments: {
              ANIMATE: {
                type: Scratch.ArgumentType.STRING,
